...
fun ToolsScreen(vm: SurveillanceViewModel) {
    ...
    Column(
        ...
        Text("OSINT TOOLKIT", fontFamily = androidx.compose.ui.text.font.FontFamily.Monospace, fontSize = 14.sp, color = EGBECyan, letterSpacing = 2.sp)
        ...
        Button(
            ...
            Text("GEOLOCATE IP", fontFamily = androidx.compose.ui.text.font.FontFamily.Monospace, fontWeight = FontWeight.Bold)
        }
        ...
        if (ipResult.isNotEmpty()) {
            ...
            Card(
                ...
                Text(ipResult, fontFamily = androidx.compose.ui.text.font.FontFamily.Monospace, fontSize = 13.sp, modifier = Modifier.padding(16.dp), color = EGBEGreen)
            }
        }

        Spacer(modifier = Modifier.height(24.dp))
        Text("UTILITY", fontFamily = androidx.compose.ui.text.font.FontFamily.Monospace, fontSize = 12.sp, color = androidx.compose.ui.graphics.Color(0xFF94A3B8))
...
fun ToolButton(label: String, onClick: () -> Unit) {
    OutlinedButton(
        ...
        Text(label, fontFamily = androidx.compose.ui.text.font.FontFamily.Monospace, fontSize = 12.sp)
    }
}